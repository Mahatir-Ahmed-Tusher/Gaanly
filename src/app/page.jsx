        ...
        <div className='absolute top-4 left-16 z-50'>
          <div className=' relative bg-[#3a3b3b] p-4 rounded-lg'>
            <p className=' text-lg text-gray-300'>
              Create your own <span className='text-lavender-400'>Playlists</span> <br />and
              add songs to <span className='text-lavender-400'>Favourite</span>
            </p>
            <div className=' flex items-center mt-2 justify-end'>
              <button onClick={handleClick} className=' bg-lavender-400 text-black px-3 py-2 rounded-lg'>Ok</button>
            </div>

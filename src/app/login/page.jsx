        ...
        <div className="container flex justify-center flex-col items-center w-screen sm:w-[90vw] lg:w-1/2">
          ...
          >
            ...
            <Link href={"/reset-password"}>
              <p className=" text-xs text-lavender-400">Forgot Password?</p>
            </Link>
            ...
            <div className=" w-full flex justify-center">
              <button
                ...
                type="button"
                className="flex items-center gap-[.7px] hover:border-lavender-400 justify-center px-4 py-2 group font-medium border-2 border-white rounded-sm"
              >
                <FaGoogle className=" group-hover:text-lavender-400" />
                oogle
              </button>
            </div>

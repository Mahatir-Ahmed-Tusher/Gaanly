      ...
      <div className=" flex flex-col lg:flex-row items-center">
        ...
        <div className=" lg:ml-10 text-gray-100 mt-12 flex flex-col gap-2">
          ...
          <div
            ...
            className="flex items-center gap-2 mt-5 group rounded-3xl py-2 px-3 hover:border-lavender-400 w-fit cursor-pointer border border-white"
          >
            <BsFillPlayFill
              size={25}
              className="text-gray-200 group-hover:text-lavender-400"
            />

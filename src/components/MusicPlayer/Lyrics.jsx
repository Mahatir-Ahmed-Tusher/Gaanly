    ...
    >
      <div className="flex justify-center items-center w-full">
        <button
          ...
          className={`${
                            activeTab === "queue" ? "border-lavender-400 border-b-2" : ""
        ...
        <button
          ...
          className={`${
                            activeTab === "lyrics" ? "border-lavender-400 border-b-2" : ""
          } text-white text-xl m-3 mt-20 sm:mt-0  font-medium`}
        >
          Lyrics
        </button>
